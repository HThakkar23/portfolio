        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
            <Button
              ...
              size="lg"
              variant="secondary"
              className="bg-white text-gray-900 hover:bg-gray-100 shadow-lg transform transition-transform hover:scale-110"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-gray-900 bg-transparent transform transition-transform hover:scale-110"
            >
